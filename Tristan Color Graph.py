...
dataMax = pd.read_csv("Daily Max Temps NP.csv")
dataMin = pd.read_csv("Daily Min Temps NP.csv")
...
#dataMin = dataMin.sort_values('Jan')
#dataMax.drop(['Mean'],axis=1, inplace=True)
...
color_bar = ColorBar(color_mapper=mapper,
                     ...
                     major_label_text_font_size="10pt", title_text_font_size="13pt", title_standoff = 15 )
...
p2 = figure(title="\n\n\n\nDaily Low Temperature Averages", title_location = 'above',
           ...
           x_axis_location="below", plot_width=1080, plot_height=450,
           tools=TOOLS, toolbar_location='right', toolbar_sticky= False)
...
output_file("NPTemperaturesFINAL.html", title="National Park Temperature Averages")
#show(column(children=[layout1,layout2], sizing_mode='scale_height'))
show(l)