...
#Delete rows where games were cancled
for i in range(29):
...
p.line(x=x, y=y,  line_width=3, color = "navy", alpha=0.3, legend="Womens Medal Count")
c1 = p.circle(x=x, y=y, color='navy', fill_color="white", size=6, legend="Womens Medal Count")
